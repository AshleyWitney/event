        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="main-navbar">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              <li class="nav-item ">
                <a class="nav-link" href="https://obiwan2.univ-brest.fr/licence/lic71/dev/CodeIgniter/index.php/accueil/afficher">
                  Home
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://obiwan2.univ-brest.fr/licence/lic71/dev/CodeIgniter/index.php/animation/touteani">
                  Programmation
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://obiwan2.univ-brest.fr/licence/lic71/dev/CodeIgniter/index.php/invite_poste/touteinv">
                Invité(e)s
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://obiwan2.univ-brest.fr/licence/lic71/dev/CodeIgniter/index.php/invite_poste/gues">
                  Guest
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://obiwan2.univ-brest.fr/licence/lic71/dev/CodeIgniter/index.php/compte/deconnexion">
                  Déconnexion
                </a>
              </li>
      ...
      <div id="main-slide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="<?php echo base_url();?>style/assets/img/slider/slide1.jpg" alt="First slide">
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="<?php echo base_url();?>style/assets/img/slider/slide2.jpg" alt="Second slide">
            <div class="carousel-caption d-md-block">
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="<?php echo base_url();?>style/assets/img/slider/slide3.jpg" alt="Third slide">
            <div class="carousel-caption d-md-block">
              <p class="fadeInUp wow" data-wow-delay=".6s">Les 48h afro</p>
